...
public class ViewEvents extends AppCompatActivity {
    ...
    class MyAdapter extends ArrayAdapter<Events> {
        ...
        public View getView(int position, View view, ViewGroup parent) {
            ...
            holder.COL1.setText(user.get(position).getStartDate());
            holder.COL2.setText(user.get(position).getEndDate());
                    ...
                    buttonupdate.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (startDAte.isEmpty()) {
                                ...
                                Toast.makeText(ViewEvents.this, "Updated successfully", Toast.LENGTH_LONG).show();
